        ...
        *********/
        ...
        public override IEnumerable<OptionsElement> GetFields(CheatContext context)
        {
            return this.SortFields(
                ...
                new CheatsOptionsCheckbox(Game1.content.LoadString(@"Strings\\StringsFromCSFiles:KeyToTheTown"), Game1.player.HasTownKey, value => Game1.player.HasTownKey = value),
